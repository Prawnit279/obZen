  ...
  return (
    <div className="flex flex-col items-center py-4">
      <svg width="120" height="120" viewBox="0 0 120 120" className="overflow-visible">
        ...
        `}</style>
        <circle className="belly-outer" cx="60" cy="60" r="40" fill="var(--accent)" />
        <circle className="belly-inner" cx="60" cy="60" r="28" fill="var(--accent)" />
        <line x1="60" y1="10"  x2="60" y2="20"  stroke="var(--dim)" strokeWidth="1.5" />
        <line x1="60" y1="100" x2="60" y2="110" stroke="var(--dim)" strokeWidth="1.5" />
  ...
  return (
    <div className="flex flex-col items-center py-4">
      <svg width="120" height="130" viewBox="0 0 120 130">
        <style>{`
          @keyframes ns-left  { 0%,45%{fill:var(--accent)} 50%,95%{fill:var(--border)} 100%{fill:var(--accent)} }
          @keyframes ns-right { 0%,45%{fill:var(--border)} 50%,95%{fill:var(--accent)} 100%{fill:var(--border)} }
        ...
        `}</style>
        <ellipse cx="60" cy="55" rx="32" ry="40" fill="none" stroke="var(--dim)" strokeWidth="1.5" />
        <circle cx="60" cy="18" r="16" fill="var(--accent)" />
  ...
  return (
    <div className="flex flex-col items-center py-4">
      <svg width="120" height="120" viewBox="0 0 120 120">
        <circle cx="50" cy="35" r="22" fill="var(--accent)" />
        <rect x="42" y="55" width="16" height="18" rx="4" fill="var(--accent)" />
        <path d="M72 42 Q88 38 90 45 Q88 52 80 50 Q74 48 72 45Z" fill="var(--accent)" />
  ...
  return (
    <div className="flex flex-col items-center py-4">
      <svg width="120" height="130" viewBox="0 0 120 130">
        ...
        `}</style>
        <circle cx="60" cy="22" r="14" fill="var(--accent)" />
        <rect x="53" y="34" width="14" height="10" rx="3" fill="var(--accent)" />
        <ellipse className="bh-torso" cx="60" cy="72" rx="22" ry="30" fill="var(--accent)" />
        <line x1="60" y1="40" x2="60" y2="50" stroke="var(--dim)" strokeWidth="1.5" strokeDasharray="2,2" />
        <polygon points="56,40 60,33 64,40" fill="var(--dim)" />
  ...
  return (
    <div className="flex flex-col items-center py-4">
      <svg width="120" height="130" viewBox="0 0 120 130">
        ...
        <circle cx="48" cy="30" r="20" fill="var(--accent)" />
        <rect x="40" y="48" width="16" height="22" rx="5" fill="var(--accent)" />
        {/* Throat area indicator */}
        <ellipse cx="48" cy="58" rx="6" ry="4" fill="var(--border)" />
  ...
  return (
    <div className="flex flex-col items-center py-4">
      <svg width="120" height="120" viewBox="0 0 120 120">
        ...
        `}</style>
        {/* Static dim box */}
        <rect x="30" y="30" width={SIDE} height={SIDE} fill="none" stroke="var(--dim)" strokeWidth="2" />
  ...
  return (
    <div className="flex flex-col items-center py-4">
      <svg width="120" height="130" viewBox="0 0 120 130">
        ...
        <circle cx="60" cy="22" r="14" fill="var(--accent)" />
        <rect x="53" y="34" width="14" height="10" rx="3" fill="var(--accent)" />
        <ellipse className="kb-belly" cx="60" cy="72" rx="22" ry="30" fill="var(--accent)" />
        {/* Expelled breath dots */}
        <circle className="kb-d1" cx="52" cy="38" r="2.5" fill="var(--dim)" />
...
function SuryaBhedanaAnim() {
  return (
    <div className="flex flex-col items-center py-4">
      <svg width="120" height="130" viewBox="0 0 120 130">
        <style>{`
          @keyframes sb-right { 0%,5%{fill:var(--accent)} 50%,55%{fill:var(--border)} 100%{fill:var(--accent)} }
          @keyframes sb-left  { 0%,5%{fill:var(--border)} 50%,55%{fill:var(--muted)} 100%{fill:var(--border)} }
...
function ChandraBhedanaAnim() {
  return (
    <div className="flex flex-col items-center py-4">
      <svg width="120" height="130" viewBox="0 0 120 130">
        <style>{`
          @keyframes cb-left  { 0%,5%{fill:var(--accent)} 50%,55%{fill:var(--border)} 100%{fill:var(--accent)} }
          @keyframes cb-right { 0%,5%{fill:var(--border)} 50%,55%{fill:var(--muted)} 100%{fill:var(--border)} }
  ...
  return (
    <div className="flex flex-col items-center py-4">
      <svg width="120" height="120" viewBox="0 0 120 120">
        ...
        <rect x="66" y="41" width="24" height="6" rx="3" fill="var(--accent)" />
